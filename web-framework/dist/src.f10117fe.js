...
function () {
  ...
  ApiSync.prototype.save = function (data) {
    var id = data.id;
    if (id) return axios_1.default.put(this.rootUrl + "/" + id, data);else return axios_1.default.post("" + this.rootUrl, data);
  };
...
},{"axios":"node_modules/axios/index.js"}],"models/Attributes.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.attributes.getAll()).then(function (_response) {
      _this.trigger('save');
    }).catch(function () {
      _this.trigger('error');
    });
...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      var handles = _this.events[eventName] || [];
      handles.push(callback);
      _this.events[eventName] = handles;
    };
...
/** @class */
function () {
  function Collection(rootUrl, deseralize) {
    this.rootUrl = rootUrl;
    this.deseralize = deseralize;
    this.models = [];
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (response) {
      response.data.forEach(function (value) {
        _this.models.push(_this.deseralize(value));
      });
...
exports.User = User;
},{"./ApiSync":"models/ApiSync.ts","./Attributes":"models/Attributes.ts","./Model":"models/Model.ts","./Eventing":"models/Eventing.ts","./Collection":"models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
collection.fetch();
},{"../models/User":"models/User.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
